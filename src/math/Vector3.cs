...
namespace Jinx.Src.Math{
    public class Vector3{
        ...
        public static readonly Vector3 X_AXIS = RIGHT;
        public static readonly Vector3 Y_AXIS = UP;
        public static readonly Vector3 Z_AXIS = FORWARD;
        ...
        public static Vector3 Normalize(Vector3 v) {
            ...
            float sizeSquared = v.x * v.x + v.y * v.y + v.z * v.z;
        ...
        public static float AngleBetween(Vector3 v1, Vector3 v2) {
            return (float)Math.Acos(Vector3.Normalize(v1).Dot(Vector3.Normalize(v2)););
        }
        ...
        public void Normalize() {
            ...
            float sizeSquared = this.x * this.x + this.y * this.y + this.z * this.z;
        ...
        public void ApplyMatrixAsNormal(Matrix4 m) {
            ...
            var v = this.Clone();
            float w = 1 / (m.mat[3] * v.x + m.mat[7] * v.y + m.mat[11] * v.z);
        ...
        public void SetScaleFromMatrix(Matrix4 m) {
            ...
            this.x = (float)Math.Sqrt(m.mat[0] * m.mat[0] + m.mat[1] * m.mat[1] + m.mat[2] * m.mat[2]);
            this.y = (float)Math.Sqrt(m.mat[4] * m.mat[4] + m.mat[5] * m.mat[5] + m.mat[6] * m.mat[6]);
            this.z = (float)Math.Sqrt(m.mat[8] * m.mat[8] + m.mat[9] * m.mat[9] + m.mat[10] * m.mat[10]);
        }
    }
}